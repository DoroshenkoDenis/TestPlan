...
1. Предусловие 1
2. Нажать "Записаться"
3. Ожидаемый результат во всех полях - сообщение "Обязательное поле" 
...
3. Ожидаемый результат - сообщение "Должно состоять из букв"
...
3. Ожидаемый результат - сообщение "Номер в формате +9 (999) 999-99-99"
...
3. Ожидаемый результат - сообщение "Неверный email"  

### Сценарий для Modalbox (неавторизованный пользователь):
1. Предусловие 2
