...
* Сценарий - 1.1
   ...
   * Заполнить форму RegisrationBlock (перейти к форме можно нажав кнопку "Записаться" в начале страницы и в тулбаре при скроле вверх)
      *  Заполнить поле Имя
...
* Сценарий - 1.6
   ...
   * Заполнить форму RegisrationBlock
      ...
      *  Нажать "Записаться"
      *  
  *  Сценарий - 1.6 контейнере "Гарантия возврата денег"
